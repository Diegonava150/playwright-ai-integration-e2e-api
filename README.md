...
tests/
  ...
  api/        products · auth
  e2e/        auth · product-search              (anonymous browser flows)
  ...
  visual/     visual (VISUAL=1, pixel-diff baselines)
prompts/      generate-test.md · heal-test.md
scripts/      ai-failure-summary.ts · run-ai-oauth.ts
.github/workflows/e2e.yml   (sharded matrix → blob merge → AI triage PR comment)
```
